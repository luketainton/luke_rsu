...
INSTALLED_APPS = [
    ...
    "allauth.socialaccount.providers.openid_connect", "ledger",
]
MIDDLEWARE = [
...
DATABASES = {"default": {"ENGINE": "django.db.backends.postgresql", "NAME": os.environ.get("POSTGRES_DB", "rsu"), "USER": os.environ.get("POSTGRES_USER", "rsu"), "PASSWORD": os.environ.get("POSTGRES_PASSWORD", ""), "HOST": os.environ.get("POSTGRES_HOST", "localhost"), "PORT": os.environ.get("POSTGRES_PORT", "5432")}}
...
if os.environ.get("OIDC_ISSUER_URL"):
    SOCIALACCOUNT_PROVIDERS = {"openid_connect": {"OAUTH_PKCE_ENABLED": True, "APPS": [{
        "provider_id": "company", "name": "Company SSO", "client_id": os.environ["OIDC_CLIENT_ID"],
