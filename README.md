...
This is a record-keeping aid, not tax advice or a completed Self Assessment return. Retain employer/broker documents and the FX source for every event. The Overview dashboard's gain/loss and CGT figures are estimates: linked records use HMRC same-day, following-30-day, Section 104 and later-acquisition matching. They include losses arising in this ledger and the annual exempt amount, but cannot know about gains or losses outside the ledger, losses previously claimed or carried forward, or the user's taxable-income position. Confirm the final calculation before filing.
